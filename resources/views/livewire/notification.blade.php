    ...
    <div class="card card-body border-0 shadow table-wrapper table-responsive">
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="#" class="fw-bold"  render="row">{{ $notification->id }}
                        </a>
                    </td>
                    <td>
                        <span class="fw-normal">{{$notification->notifiable_id}}</span>
                    </td>
                    <td><span class="fw-normal">{{$notification->data}}</span></td>
                    ...
                    <td><span class="fw-bold">{{$courrier->user->email}}</span></td>
